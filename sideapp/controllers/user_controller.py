...
from flask_login import login_user, logout_user, login_required, current_user # related to endpoints for user model
from marshmallow import ValidationError

@lm.user_loader # Handles people being logged in
def load_user(user):
...
@users.route("/users/signup/", methods = ["GET", "POST"]) # First route added (signup)
def sign_up():
